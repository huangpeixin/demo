!function (n, i) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = i() : "function" == typeof define && define.amd ? define(i) : (n = "undefined" != typeof globalThis ? globalThis : n || self).PinyinMatch = i()
}(this, (function () {
    "use strict";
    ...
    function n(n, i, a) {
        ...
        }(i)) in n ? Object.defineProperty(n, i, {value: a, enumerable: !0, configurable: !0, writable: !0}) : n[i] = a, n
    }

    var i = [], a = {}, u = {};

    function e(n) {
        for (var i = [], a = n.length, u = [], e = 0; a >= e; e++) u.push(!0);
        return o(0, n, [], i, u), i
    }

    function o(n, a, u, e, r) {
        var g = a.length;
        if (n !== g) for (var t = function () {
            var g = a.substring(n, h + 1), t = !1;
            if (i.some((function (n) {
                return 0 === n.indexOf(g)
            })) && !a[h + 1] && r[h + 1]) {
                if (1 === g.length) u.push(g); else {
                    var f = [];
                    i.forEach((function (n) {
                        0 === n.indexOf(g) && f.push(n)
                    })), u.push(f)
                }
                t = !0
            } else -1 !== i.indexOf(g) && r[h + 1] && (u.push(g), t = !0);
            if (t) {
                var s = e.length;
                o(h + 1, a, u, e, r), e.length === s && (r[h + 1] = !1), u.pop()
            }
        }, h = n; g > h; h++) t(); else e.push(u.join(" "))
    }
    ...
    function g(i, o) {
        if (!i || !o) return !1;
        i = i.toLowerCase(), o = o.replace(/\s+/g, "").toLowerCase();
        var r = i.indexOf(o);
        if (-1 !== r) return [r, r + o.length - 1];
        var g = t(i.split(""), [o.split("")], o);
        if (g) return g;
        var h, f, s = function (n) {
        ...
        return t(s, u[o] || (f = [], e(h = o).forEach((function (n) {
            var i = n.split(" "), a = i.length - 1;
            i[a].indexOf(",") ? i[a].split(",").forEach((function (n) {
                i.splice(a, 1, n), f.push(JSON.parse(JSON.stringify(i)))
            })) : f.push(i)
        })), 0 !== f.length && f[0].length === h.length || f.push(h.split("")), u = n({}, h, f), f), o)
    }

    function t(n, i, a) {
        for (var u = 0; n.length > u; u++) for (var e = 0; i.length > e; e++) {
            var o = i[e], g = o.length, t = g === a.length, h = !0, f = 0, s = 0, l = 0;
            if (n.length >= g) {
                for (; o.length > f; f++) if (0 === f && " " === n[u + f + s]) s += 1, f -= 1; else if (" " === n[u + f + l]) l += 1, f -= 1; else if (!r(n[u + f + l], o[f], !n[u + f + 1] || !o[f + 1], t)) {
                    h = !1;
                    break
                }
                if (h) return [u + s, l + u + f - 1]
            }
        }
        return !1
    }
    ...
    var h = {
        match: function (n) {
            var u = {}, e = ["ju", "jun", "jue", "juan", "qu", "qun", "que", "xuan", "xu", "xue", "yu", "yuan", "yue", "yun", "nve", "lve"],
                o = ["lv", "lve", "nv", "nve"];
            return Object.keys(n).forEach((function (a) {
                if (u[a] = n[a], i.push(a), e.includes(a)) {
                    var r = -1 !== (g = a).indexOf("u") ? g.replace("u", "v") : g.replace("v", "u");
                    u[r] = n[a], i.push(r)
                }
                var g;
                if (o.includes(a)) {
                ...
                var i = {};
                for (var a in n) for (var u = n[a], e = 0, o = u.length; o > e; e++) i[u[e]] = i[u[e]] ? i[u[e]] + " " + a : a;
                return i
            }(u), g
        }({
            a: "阿啊呵腌嗄吖锕",
